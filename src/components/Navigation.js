...
//?' + queryParams.toString()
    ...
    searchActions.executeUniversialQuery();
  };
      ...
      <nav className="" role="navigation">
        <div className="container mx-auto p-4 flex flex-wrap items-center md:flex-no-wrap">
          ...
          <div className="w-full md:w-auto md:flex-grow md:flex md:items-center">
            <ul className="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-revert md:mx-0 md:mt-0 md:pt-0 md:mr-4 md:ml-auto lg:mr-8 md:border-0">
              <li>
              ...
              <li>
                    {/* <div className="flex">
                      <SearchBar placeholder="Search for anything..." onSearch={handleSearch} />
                    </div> */}
